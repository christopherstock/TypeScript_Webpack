...
const test_1 = require("./de/mayflower/mfg/test");
const test_2 = require("./de/mayflower/mfg/test");
// import {MfgVersion} from './de/mayflower/mfg/base/MfgVersion';
console.log("Welcome!! 7");
console.dir(test_1.de_mayflower_mfg_mfg);
console.dir(test_2.de_mayflower_mfg_mfginit);
var Main;
(function (Main) {
    // Example A ===================================================================================================
...
window.onload = function () {
    ...
    //invoke main method
    test_1.de_mayflower_mfg_mfg.Mfg.main();
};
/*****************************************************************************
