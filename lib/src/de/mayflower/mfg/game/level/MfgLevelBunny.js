...
class MfgLevelBunny extends src_1.MfgLevel {
    ...
    *****************************************************************************/
    setupGlassPanes() {
        ...
        glassPane1.physicsImpostor = new BABYLON.PhysicsImpostor(glassPane1, BABYLON.PhysicsImpostor.BoxImpostor, {
            mass: 0,
            friction: 0.0,
            restitution: 0.0
        }, src_1.MfgScene.scene);
        glassPane2.physicsImpostor = new BABYLON.PhysicsImpostor(glassPane2, BABYLON.PhysicsImpostor.BoxImpostor, {
            mass: 0,
            friction: 0.0,
            restitution: 0.0
        }, src_1.MfgScene.scene);
